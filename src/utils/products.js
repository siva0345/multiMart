...
export const SliderData = [
  {
      ...
      desc: "Luxurious comfort for your living space awaits on our sofa collection.",
      cover: sofaSlide,
  },
  {
      id: 2,
      title: "50% Off For Your First Shopping",
      desc: "Experience the power of connectivity in the palm of your hand with our latest mobiles.",
      cover: phone08,
  },
  {
      id: 3,
      title: "50% Off For Your First Shopping",
      desc: "Elevate your audio experience with seamless freedom using our premium wireless headphones.",
      cover: wireless01,
  },
  {
      id: 4,
      title: "50% Off For Your First Shopping",
      desc: "Timeless elegance meets modern innovation in our exquisite collection of watches.",
      cover: watchSlide,
  },
];
...
export const serviceData = [
  {
    ...
    title: "Free Shipping",
    subtitle: "Available to all locations in India",
    bg: "#fdefe6",
  },
  {
    icon: <ion-icon name="card"></ion-icon>,
    title: "Safe Payment",
    subtitle: "Credit card payments are also available",
    bg: "#ceebe9",
  },
  {
    icon: <ion-icon name="shield-half-outline"></ion-icon>,
    title: "Secure Payment",
    subtitle: "Experience peace of mind with our secure payment solutions.",
    bg: "#e2f2b2",
  },
  {
    icon: <ion-icon name="headset"></ion-icon>,
    title: " Back Guarantee",
    subtitle: "Ensuring your satisfaction is our top priority.",
    bg: "#d6e5fb",
  },
];
